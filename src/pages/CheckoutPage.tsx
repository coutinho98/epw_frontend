...
const CheckoutPage = () => {
    ...
    const handleCalculateShipping = async () => {
        ...
        try {
            const mockResponse: ShippingQuote[] = [
                {
                    id: 'mock-1',
                    name: 'PAC',
                    price: 25.50,
                    company: {
                        name: 'Correios',
                        picture: 'url-para-imagem-correios.png'
                    },
                    delivery_time: 10,
                },
                {
                ...
                },
                {
                    ...
                    company: {
                        name: 'Jadlog',
                        picture: 'url-para-imagem-jadlog.png'
                    },
                    delivery_time: 7,
                },
            ];
            ...
            setShippingQuotes(mockResponse);
            setSelectedShipping(mockResponse[0].id);
